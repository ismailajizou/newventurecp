...
const Hero = () => {
  ...
  <div style={{ border: '5px solid #4A6CF7', borderRadius: '50%', overflow: 'hidden' }}>
   
    <Image
      src="/images/hero/hero-bck.png"
      width={1200} // Adjust this value to match your h1 size
      height={500} // Adjust this value to match your h1 size
      objectFit="contain"
      alt="Background image"
      priority
    />
...
<span className=" w-full dark:block ">
        <div style={{ position: 'relative' }}>
  <div style={{ position: 'absolute', top: '-400px', width: '100%',opacity: 0.5 , display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <div style={{ border: '5px solid #FFFFFF', borderRadius: '50%', overflow: 'hidden' }}>
